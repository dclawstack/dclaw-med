...
### Can I run DClaw Med without Kubernetes?

Yes, for local development:

```bash
cd dclaw-med/frontend && npm run dev
cd dclaw-med/backend && uvicorn dclaw_med.main:app --reload
```
